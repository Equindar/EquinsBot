...
class Guide:
    ...
    async def guide_crashcourse(self, ctx):
        ...
        embed.add_field(name="Step #2: Bind your Steam Profile to your Profile", value="```!player set steam [https://steamcommunity.com/ ... ]```Before you continue with Step #3, a Staff Member has to review your Player profile.\n\u200b \u200b", inline=False)
