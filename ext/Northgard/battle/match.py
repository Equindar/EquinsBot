...
class Match:
    ...
    async def dummy_match(self, ctx, number: int):
        ...
        if number == 1:
            ...
            embed.set_footer(text='now: Banning Phase',icon_url='https://gamepedia.cursecdn.com/northgard_gamepedia_en/2/2c/The_Value_of_Great_Deeds-42x42.png')
        ...
        if number == 2:
            ...
            embed.set_thumbnail(url = "https://vignette.wikia.nocookie.net/callofduty/images/e/e3/Personal_N7_vs.png")
            embed.set_footer(text='now: Picking Phase',icon_url='https://gamepedia.cursecdn.com/northgard_gamepedia_en/2/2c/The_Value_of_Great_Deeds-42x42.png')
            embed.add_field(name='Team #1', value='```Ban:      Dragon\n1st Pick: Boar\n2nd Pick: Bear```')
        ...
        if number == 3:
            ...
            embed.set_thumbnail(url = "https://vignette.wikia.nocookie.net/callofduty/images/e/e3/Personal_N7_vs.png")
            embed.set_footer(text='now: Fighting...',icon_url='https://gamepedia.cursecdn.com/northgard_gamepedia_en/0/0c/Young_and_Proud-42x42.png')
            embed.add_field(name='Team #1', value='```Ban:      Dragon\n1st Pick: Boar\n2nd Pick: Bear```')
            embed.add_field(name='Team #2', value='```Ban:      Snake\n1st Pick: Raven\n2nd Pick: Wolf```')
        ...
        if number == 4:
            ...
            embed.set_thumbnail(url = "https://vignette.wikia.nocookie.net/callofduty/images/e/e3/Personal_N7_vs.png")
            embed.set_footer(text='finished: Team #1 is victorious!',icon_url='https://gamepedia.cursecdn.com/northgard_gamepedia_en/5/52/Fame.png')
